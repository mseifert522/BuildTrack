...
export default function Layout({ children }: LayoutProps) {
  ...
  const navItems = [
    { to: '/', icon: LayoutDashboard, label: 'Dashboard', show: true, badge: null },
    { to: '/projects', icon: FolderOpen, label: 'Projects', show: true, badge: null },
    { to: '/punch-list', icon: ClipboardList, label: 'Punch Lists', show: true, badge: null },
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <LogOut className="w-3.5 h-3.5 hidden sm:block" style={{ color: '#9CA3AF' }} />
            </div>
          </div>
        </header>
